...
public class Jdbc3DDL {
	 ...
	 */
		...
		//st.executeUpdate(createQuery);//DDL islemleri icin 0 degerini dondurur
...
//		System.out.println("isciler tablosu silindi....");
		...
		========================================================================*/ 
		String alterQuery1 = "ALTER TABLE isciler"
							+ " ADD isim VARCHAR2(20)";
		
		//st.executeUpdate(alterQuery1);
		//System.out.println("isciler tablosuna isim sütunu eklendi.");
		...
		String alterQuery2 = "ALTER TABLE isciler"
							+ " ADD (soyisim VARCHAR2(20),"
							+ " sehir VARCHAR2(10))";
		
		//st.execute(alterQuery2);
		//System.out.println("isciler tablosuna soyisim ve sehir sutunu daha eklendi");
		
		
		/*=======================================================================
		  ORNEK5:isciler tablosundaki soyisim sutunu siliniz.
		========================================================================*/ 
		String alterQuery3 = "ALTER TABLE isciler"
							+ " DROP COLUMN soyisim";
		...
		========================================================================*/
		String alterQuery4 = "ALTER TABLE isciler"
							+ " RENAME TO calisanlar";
		
		//st.execute(alterQuery4);
		//System.out.println("isciler tablosunun adı calisanlar olarak degistirildi...");
